...
class AddressDetailPageAccidents extends StatefulWidget {
  final String addressId;
  final String selectedCity;

  AddressDetailPageAccidents({
    required this.addressId,
    required this.selectedCity,
  });

  @override
  _AddressDetailPageAccidentsState createState() =>
      _AddressDetailPageAccidentsState();
}

class _AddressDetailPageAccidentsState
    extends State<AddressDetailPageAccidents> {
            ...
            child: FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, userSnapshot) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  ...
                  stream: Database.getAddressStreamByIdAccidents(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      String subcategory = address['subcategory'];
                      ...
                      return Column(
                        children: [
                          AddressdetailAppbarMain(
                            ...
                            onDelete: isAdmin
                                ? (String id, String city) {
                                    Database.deleteAddressAccidents(id, city);
