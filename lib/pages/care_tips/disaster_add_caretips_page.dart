...
class DisasterAddCareTipPage extends StatefulWidget {
  @override
  _DisasterAddCareTipPageState createState() => _DisasterAddCareTipPageState();
}

class _DisasterAddCareTipPageState extends State<DisasterAddCareTipPage> {
  ...
  void _addCareTip() async {
    if (_formKey.currentState!.validate() && _thumbnail != null) {
      final diastercareTip = DisasterCareTip(
        id: Uuid().v4(),
      ...
      await _databaseMethods.addDisasterCareTip(diastercareTip);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Add Disaster Preparedness Care Tip'),
      ),
      body: Padding(
