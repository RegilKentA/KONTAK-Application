...
class BitesCareTipsPage extends StatefulWidget {
  @override
  State<BitesCareTipsPage> createState() => _BitesCareTipsPageState();
}

class _BitesCareTipsPageState extends State<BitesCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Bites")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Bites."));
                }
