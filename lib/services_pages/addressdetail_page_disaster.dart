...
class AddressDetailPageDisaster extends StatefulWidget {
  final String addressId;
  final String selectedCity;

  AddressDetailPageDisaster({
    required this.addressId,
    required this.selectedCity,
  });

  @override
  _AddressDetailPageDisasterState createState() =>
      _AddressDetailPageDisasterState();
}

class _AddressDetailPageDisasterState extends State<AddressDetailPageDisaster> {
            ...
            child: FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, userSnapshot) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  ...
                  stream: Database.getAddressStreamByIdDisaster(
                      ...
                      return Column(
                        children: [
                          AddressdetailAppbarMain(
                            ...
                            onDelete: isAdmin
                                ? (String id, String city) {
                                    Database.deleteAddressDisaster(id, city);
