...
class AddressDetailPageFire extends StatefulWidget {
  final String addressId;
  final String selectedCity;

  AddressDetailPageFire({
    required this.addressId,
    required this.selectedCity,
  });

  @override
  _AddressDetailPageFireState createState() => _AddressDetailPageFireState();
}

class _AddressDetailPageFireState extends State<AddressDetailPageFire> {
            ...
            child: FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, userSnapshot) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  ...
                  stream: Database.getAddressStreamByIdFire(
                      ...
                      return Column(
                        children: [
                          AddressdetailAppbarMain(
                            ...
                            onDelete: isAdmin
                                ? (String id, String city) {
                                    Database.deleteAddressFire(id, city);
