...
import 'package:kontak_application_2/services_pages/addeditaddress_page_accidents.dart';
import 'package:kontak_application_2/services_pages/addresslist_da_page.dart';
import 'package:kontak_application_2/services_pages/addresslist_ia_page.dart';
import 'package:kontak_application_2/services_pages/addresslist_va_page.dart';
import 'package:kontak_application_2/services_pages/addresslist_ea_page.dart';

class AccidentsSubcategoryPage extends StatefulWidget {
  final String? selectedCity; // Add this parameter

  AccidentsSubcategoryPage({this.selectedCity});

  @override
  State<AccidentsSubcategoryPage> createState() =>
      _AccidentsSubcategoryPageState();
}

class _AccidentsSubcategoryPageState extends State<AccidentsSubcategoryPage> {
                ...
                child: Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      // vehicular
                      CaretipsListItem(
                        imagePath: 'assets/images/vehicularaccident.png',
                        text: 'VEHICULAR',
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>
                                  AddressListVehicularAccidentsPage(
                      ...
                      SizedBox(height: 10),
                      CaretipsListItem(
                        imagePath: 'assets/images/drowningaccident.png',
                        text: 'DROWNING',
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>
                                  AddressListDrowningAccidentsPage(
                                selectedCity: widget.selectedCity!,
                              ), // Replace with your destination page
                            ),
                          );
                      ...
                      SizedBox(height: 10),
                      CaretipsListItem(
                        imagePath: 'assets/images/electricalaccident.png',
                        text: 'ELECTRICAL',
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>
                                  AddressListElectricalAccidentsPage(
                                selectedCity: widget.selectedCity!,
                              ), // Replace with your destination page
                            ),
                          );
                      ...
                      CaretipsListItem(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  AddressListInjuriesAccidentsPage(
                                selectedCity: widget.selectedCity!,
                              ), // Replace with your destination page
                            ),
                          );
          ...
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AddEditAddressPageAccidents(
                            selectedCity: widget.selectedCity!,
                          )),
                );
              },
