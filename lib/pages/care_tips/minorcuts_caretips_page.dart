...
class MinorcutsCareTipsPage extends StatefulWidget {
  @override
  State<MinorcutsCareTipsPage> createState() => _MinorcutsCareTipsPageState();
}

class _MinorcutsCareTipsPageState extends State<MinorcutsCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) =>
                        careTip.subcategory == "Log Roll Technique")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text(
                          "No care tips available for Log Roll Technique."));
                }
