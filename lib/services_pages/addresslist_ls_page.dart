...
class AddressListLandslidePage extends StatefulWidget {
  final String? selectedCity;

  AddressListLandslidePage({this.selectedCity});

  @override
  _AddressListLandslidePageState createState() =>
      _AddressListLandslidePageState();
}

class _AddressListLandslidePageState extends State<AddressListLandslidePage> {
  @override
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    ...
                    height: 80, // Set the height you want
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream:
                        Database.getAddressStreamLandslide(widget.selectedCity),
