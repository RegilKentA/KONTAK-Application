...
import 'package:kontak_application_2/services_pages/addeditaddress_page_fire.dart';
import 'package:kontak_application_2/services_pages/address_database.dart';
import 'package:kontak_application_2/services_pages/addressdetail_page_fire.dart';

class AddressListPageFire extends StatefulWidget {
  final String? selectedCity; // Add this parameter

  AddressListPageFire({this.selectedCity}); // Constructor with selectedCity

  @override
  _AddressListPageFireState createState() => _AddressListPageFireState();
}

class _AddressListPageFireState extends State<AddressListPageFire> {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamFire(widget.selectedCity),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return AddressListTile(
                              ...
                              destinationPage: AddressDetailPageFire(
                                addressId: addressId,
          ...
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AddEditAddressPageFire(
                            selectedCity: widget.selectedCity!,
                          )),
                );
              },
