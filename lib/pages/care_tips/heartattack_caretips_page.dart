...
class HeartattackCareTipsPage extends StatefulWidget {
  @override
  State<HeartattackCareTipsPage> createState() =>
      _HeartattackCareTipsPageState();
}

class _HeartattackCareTipsPageState extends State<HeartattackCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Heart Attack")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Heart Attack."));
                }
