...
class PoisoningCareTipsPage extends StatefulWidget {
  @override
  State<PoisoningCareTipsPage> createState() => _PoisoningCareTipsPageState();
}

class _PoisoningCareTipsPageState extends State<PoisoningCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Poisoning")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Poisoning."));
                }
