...
class AddressListInjuriesAccidentsPage extends StatefulWidget {
  final String? selectedCity;

  AddressListInjuriesAccidentsPage({this.selectedCity});

  @override
  _AddressListInjuriesAccidentsPageState createState() =>
      _AddressListInjuriesAccidentsPageState();
}

class _AddressListInjuriesAccidentsPageState
    extends State<AddressListInjuriesAccidentsPage> {
  @override
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamInjuriesAccidents(
                        widget.selectedCity),
