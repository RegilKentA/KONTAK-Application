...
class FractureCareTipsPage extends StatefulWidget {
  @override
  State<FractureCareTipsPage> createState() => _FractureCareTipsPageState();
}

class _FractureCareTipsPageState extends State<FractureCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Fracture")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Fracture."));
                }
