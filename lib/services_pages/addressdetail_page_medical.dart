...
class AddressDetailPageMedical extends StatefulWidget {
  final String addressId;
  final String selectedCity;

  AddressDetailPageMedical({
    required this.addressId,
    required this.selectedCity,
  });

  @override
  _AddressDetailPageMedicalState createState() =>
      _AddressDetailPageMedicalState();
}

class _AddressDetailPageMedicalState extends State<AddressDetailPageMedical> {
            ...
            child: FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, userSnapshot) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  ...
                  stream: Database.getAddressStreamByIdMedical(
                      ...
                      return Column(
                        children: [
                          AddressdetailAppbarMain(
                            ...
                            onDelete: isAdmin
                                ? (String id, String city) {
                                    Database.deleteAddressMedical(id, city);
