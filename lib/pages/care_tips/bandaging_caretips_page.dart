...
class BandagingCareTipsPage extends StatefulWidget {
  @override
  State<BandagingCareTipsPage> createState() => _BandagingCareTipsPageState();
}

class _BandagingCareTipsPageState extends State<BandagingCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Bandaging")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Bandaging."));
                }
