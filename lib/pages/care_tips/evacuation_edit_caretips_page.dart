...
class EvacuationEditCareTipPage extends StatefulWidget {
  final EvacuationCareTip evacuationCareTip;

  EvacuationEditCareTipPage({required this.evacuationCareTip});

  @override
  _EvacuationEditCareTipPageState createState() =>
      _EvacuationEditCareTipPageState();
}

class _EvacuationEditCareTipPageState extends State<EvacuationEditCareTipPage> {
  ...
  void initState() {
    super.initState();
    _titleController.text = widget.evacuationCareTip.title;
    _secondTitleController.text = widget.evacuationCareTip.secondTitle;
    _detailedInfoController.text = widget.evacuationCareTip.detailedInfo;
    _images = widget.evacuationCareTip.images;
    _thumbnailUrl = widget.evacuationCareTip.thumbnail;
  }
  ...
  void _editCareTip() async {
    if (_formKey.currentState!.validate()) {
      final updatedEvacuationCareTip = EvacuationCareTip(
        id: widget.evacuationCareTip.id,
      ...
      await _databaseMethods.updateEvacuationCareTip(updatedEvacuationCareTip);
