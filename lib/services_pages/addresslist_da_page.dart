...
class AddressListDrowningAccidentsPage extends StatefulWidget {
  final String? selectedCity;

  AddressListDrowningAccidentsPage({this.selectedCity});

  @override
  _AddressListDrowningAccidentsPageState createState() =>
      _AddressListDrowningAccidentsPageState();
}

class _AddressListDrowningAccidentsPageState
    extends State<AddressListDrowningAccidentsPage> {
  @override
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    'assets/images/drowningaccident.png',
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamDrowningAccidents(
                        widget.selectedCity),
