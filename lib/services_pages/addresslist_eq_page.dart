...
class AddressListEarthquakePage extends StatefulWidget {
  final String? selectedCity;

  AddressListEarthquakePage({this.selectedCity});

  @override
  _AddressListEarthquakePageState createState() =>
      _AddressListEarthquakePageState();
}

class _AddressListEarthquakePageState extends State<AddressListEarthquakePage> {
  @override
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamEarthquake(
                        widget.selectedCity),
