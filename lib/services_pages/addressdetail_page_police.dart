...
class AddressDetailPagePolice extends StatefulWidget {
  final String addressId;
  final String selectedCity;

  AddressDetailPagePolice({
    required this.addressId,
    required this.selectedCity,
  });

  @override
  _AddressDetailPagePoliceState createState() =>
      _AddressDetailPagePoliceState();
}

class _AddressDetailPagePoliceState extends State<AddressDetailPagePolice> {
            ...
            child: FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, userSnapshot) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  ...
                  stream: Database.getAddressStreamByIdPolice(
                      ...
                      return Column(
                        children: [
                          AddressdetailAppbarMain(
                            ...
                            onDelete: isAdmin
                                ? (String id, String city) {
                                    Database.deleteAddressPolice(id, city);
