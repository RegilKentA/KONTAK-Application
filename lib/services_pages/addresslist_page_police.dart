...
import 'package:kontak_application_2/services_pages/addeditaddress_page_police.dart';
import 'package:kontak_application_2/services_pages/address_database.dart';
import 'package:kontak_application_2/services_pages/addressdetail_page_police.dart';

class AddressListPagePolice extends StatefulWidget {
  final String? selectedCity; // Add this parameter

  AddressListPagePolice({this.selectedCity}); // Constructor with selectedCity

  @override
  _AddressListPagePoliceState createState() => _AddressListPagePoliceState();
}

class _AddressListPagePoliceState extends State<AddressListPagePolice> {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream:
                        Database.getAddressStreamPolice(widget.selectedCity),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return AddressListTile(
                              ...
                              destinationPage: AddressDetailPagePolice(
                                addressId: addressId,
          ...
          ? FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AddEditAddressPagePolice(
                          selectedCity: widget.selectedCity!)),
                );
              },
              child: Icon(
