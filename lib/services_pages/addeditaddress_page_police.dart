...
class AddEditAddressPagePolice extends StatefulWidget {
  ...
  @override
  _AddEditAddressPagePoliceState createState() =>
      _AddEditAddressPagePoliceState();
}

class _AddEditAddressPagePoliceState extends State<AddEditAddressPagePolice> {
  ...
  Future<void> _loadAddress() async {
    var doc = await Database.getAddressByIdPolice(
                        ...
                        onPressed: _isLoading
                            ...
                            : () async {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  if (widget.addressId == null) {
                                    await Database.addAddressPolice(
                                        widget.selectedCity!, addressData);
                                  } else {
                                    addressData['id'] = widget.addressId!;
                                    await Database.updateAddressPolice(
                                        widget.selectedCity!, addressData);
                                  }
