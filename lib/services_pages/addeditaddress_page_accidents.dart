...
class AddEditAddressPageAccidents extends StatefulWidget {
  ...
  @override
  _AddEditAddressPageAccidentsState createState() =>
      _AddEditAddressPageAccidentsState();
}

class _AddEditAddressPageAccidentsState
    extends State<AddEditAddressPageAccidents> {
  ...
  Future<void> _loadAddress() async {
    var doc = await Database.getAddressByIdAccidents(
                        ...
                        onPressed: _isLoading
                            ...
                            : () async {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  if (widget.addressId == null) {
                                    await Database.addAddressAccidents(
                                        widget.selectedCity!, addressData);
                                  } else {
                                    addressData['id'] = widget.addressId!;
                                    await Database.updateAddressAccidents(
                                        widget.selectedCity!, addressData);
                                  }
