...
class AddressListElectricalAccidentsPage extends StatefulWidget {
  final String? selectedCity;

  AddressListElectricalAccidentsPage({this.selectedCity});

  @override
  _AddressListElectricalAccidentsPageState createState() =>
      _AddressListElectricalAccidentsPageState();
}

class _AddressListElectricalAccidentsPageState
    extends State<AddressListElectricalAccidentsPage> {
  @override
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    'assets/images/electricalaccident.png',
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamElectricalAccidents(
                        widget.selectedCity),
