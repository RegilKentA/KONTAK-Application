...
class StrokeCareTipsPage extends StatefulWidget {
  @override
  State<StrokeCareTipsPage> createState() => _StrokeCareTipsPageState();
}

class _StrokeCareTipsPageState extends State<StrokeCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Stroke")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Stroke."));
                }
