...
class AddEditAddressPageDisaster extends StatefulWidget {
  final String? addressId;
  final String? selectedCity;

  AddEditAddressPageDisaster({
    this.addressId,
    this.selectedCity,
  });

  @override
  _AddEditAddressPageDisasterState createState() =>
      _AddEditAddressPageDisasterState();
}

class _AddEditAddressPageDisasterState
    extends State<AddEditAddressPageDisaster> {
  ...
  Future<void> _loadAddress() async {
    var doc = await Database.getAddressByIdDisaster(
                        ...
                        onPressed: _isLoading
                            ...
                            : () async {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  // Use existing thumbnail URL if no new thumbnail is selected
                                  String? thumbnailUrl;
                                  ...
                                  var addressData = {
                                    ...
                                    'stationType': 'Disaster',
                                  };

                                  if (widget.addressId == null) {
                                    await Database.addAddressDisaster(
                                        widget.selectedCity!, addressData);
                                  } else {
                                    addressData['id'] = widget.addressId!;
                                    await Database.updateAddressDisaster(
                                        widget.selectedCity!, addressData);
                                  }
