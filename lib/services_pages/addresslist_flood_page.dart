...
class AddressListFloodPage extends StatefulWidget {
  final String? selectedCity;

  AddressListFloodPage({this.selectedCity});

  @override
  _AddressListFloodPageState createState() => _AddressListFloodPageState();
}

class _AddressListFloodPageState extends State<AddressListFloodPage> {
  @override
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamFlood(widget.selectedCity),
