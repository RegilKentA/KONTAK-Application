...
class HeatstrokeCareTipsPage extends StatefulWidget {
  @override
  State<HeatstrokeCareTipsPage> createState() => _HeatstrokeCareTipsPageState();
}

class _HeatstrokeCareTipsPageState extends State<HeatstrokeCareTipsPage> {
            ...
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Heat Stroke")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text("No care tips available for Heat Stroke."));
                }
