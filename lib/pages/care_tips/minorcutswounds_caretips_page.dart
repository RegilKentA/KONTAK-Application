...
class MinorcutsWoundsCareTipsPage extends StatefulWidget {
  @override
  State<MinorcutsWoundsCareTipsPage> createState() =>
      _MinorcutsWoundsCareTipsPageState();
}

class _MinorcutsWoundsCareTipsPageState
    extends State<MinorcutsWoundsCareTipsPage> {
          ...
          Expanded(
            child: StreamBuilder<List<CareTip>>(
              ...
              builder: (context, snapshot) {
                ...
                // Filter care tips to only
                final careTips = snapshot.data!
                    .where((careTip) => careTip.subcategory == "Wounds")
                    .toList();

                if (careTips.isEmpty) {
                  return Center(
                      child: Text(
                          "No care tips available for Minor Cuts and Wounds"));
                }
