...
class AddressListVehicularAccidentsPage extends StatefulWidget {
  final String? selectedCity;

  AddressListVehicularAccidentsPage({this.selectedCity});

  @override
  _AddressListVehicularAccidentsPageState createState() =>
      _AddressListVehicularAccidentsPageState();
}

class _AddressListVehicularAccidentsPageState
    extends State<AddressListVehicularAccidentsPage> {
  @override
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    'assets/images/vehicularaccident.png',
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamVehicularAccidents(
                        widget.selectedCity),
