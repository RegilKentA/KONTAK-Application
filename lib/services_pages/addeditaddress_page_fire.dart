...
class AddEditAddressPageFire extends StatefulWidget {
  ...
  @override
  _AddEditAddressPageFireState createState() => _AddEditAddressPageFireState();
}

class _AddEditAddressPageFireState extends State<AddEditAddressPageFire> {
  ...
  Future<void> _loadAddress() async {
    var doc = await Database.getAddressByIdFire(
