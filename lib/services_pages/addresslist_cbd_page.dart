...
class AddressListChildbirthdeliveryPage extends StatefulWidget {
  final String? selectedCity;

  AddressListChildbirthdeliveryPage({this.selectedCity});

  @override
  _AddressListChildbirthdeliveryPageState createState() =>
      _AddressListChildbirthdeliveryPageState();
}

class _AddressListChildbirthdeliveryPageState
    extends State<AddressListChildbirthdeliveryPage> {
  @override
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: Database.getAddressStreamChildbirthdelivery(
                        widget.selectedCity),
